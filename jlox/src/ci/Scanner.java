...
public class Scanner {
    ...
    private void blockComment() {
        ...
        if(isAtEnd()){
            Lox.error(line, "Unexpected end of block comment");
            return;
        }
    ...
    private void number() {
        ...
        addToken(TokenType.NUMBER, toNumber(source.substring(start, current)));
    }
    ...
    private double toNumber(String str) {
        ...
        if(str.charAt(idx) == '-') { negative = true; idx++; }
        ...
        for (int i = idx; i < str.length(); i++) {
            ...
            if (isDigit(c)){
                ...
                if (decimal == -1){
                    ...
                    double fraction = digit * Math.pow(10, decimal - i);
